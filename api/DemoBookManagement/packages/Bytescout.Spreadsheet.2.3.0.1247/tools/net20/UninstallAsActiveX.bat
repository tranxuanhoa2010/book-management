...
%windir%\Microsoft.NET\Framework\v2.0.50727\regasm.exe %windir%\System32\Bytescout.Spreadsheet.dll /tlb:%windir%\System32\Bytescout.Spreadsheet.tlb /unregister 
